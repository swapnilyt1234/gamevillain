...
exports.run = async (client, message, args) => {
    ...
    if (!channel.body.items[0]) return message.channel.send("No such channel found. Please try again.");
...
exports.help = {
    name: "ytstats",
    description: "Displays information about a youtube channel",
    usage: "?ytstats (channel name)",
    example: "?ytstats (tseries)"
}
