...
module.exports = async (client, message) => {
  ...
  // Verification Site
  if (message.channel.id === "732939667371982989") {
    ...
    if (message.content.startsWith("resend")) {
      ...
      const dm = new Discord.MessageEmbed()
        ...
        .addField(
          "Put your code into the channel.",
    ...
    if (!client.config.owners.includes(message.author.id)) {
      // The owner of the bot cannot get any verification codes.
      if (!message.author.bot) {
        // If the user was a robot, well return it.
